            ...
            {(provided) => (
              ...
              >
                <div>
                  ...
                  <ActivityProgress
                    activity={activity}
                    onUpdate={(updates) => onEditActivity(activity.id, updates)}
                  />
                  {activity.reminder && (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full bg-red-400/20 text-red-400 hover:bg-red-400/30"
                  >
                    <Trash2 size={18} />
                  </button>
                </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              {currentWeekActivities
                ...
                .map((activity, index) => renderActivity(activity, index, dayIndex))}
            </div>
            <button
